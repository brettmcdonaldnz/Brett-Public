...
# answer:
# int_list = [1,2,3,4,5]
# int_list.remove(int(input('Omit an int between 1 and 5: ')))
# alt # remove_num = int(input('Omit which number? '))
# alt # int_list.pop(int_list.index(remove_num))
# for i in int_list:
...
distanceToShops = 600
busStopDistance =400
print(not distanceToShops < 500 and not busStopDistance < 500)
